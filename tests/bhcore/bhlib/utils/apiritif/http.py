...
class http(object):
    ...
    def request(method, address, session=None,
                params=None, headers=None, cookies=None, cp_cookies=None, data=None, json=None, files=None,
                allow_redirects=True, timeout=30, verify=True):
        """
        ...
        http.log.debug(msg, params, headers, cookies, cp_cookies, data, json, files, allow_redirects, timeout, verify)
        ...
        settings = session.merge_environment_settings(prepared.url, {}, False, verify, None)
        try:
...
class HTTPTarget(object):
    ...
    def request(self, method, path,
                ...
                allow_redirects=None, timeout=None, verify=True):
        """
        ...
        response = http.request(method, address, session=self.__session,
                                ...
                                allow_redirects=allow_redirects, timeout=timeout, verify=verify)
...
class HTTPResponse(object):
    def __init__(self, py_response):
        ...
        self.cp_cookies = py_response.cookies
    ...
    def __eq__(self, other):
        ...
        return isinstance(other, self.__class__) \
               ...
               and self.cp_cookies == other.cp_cookies \
