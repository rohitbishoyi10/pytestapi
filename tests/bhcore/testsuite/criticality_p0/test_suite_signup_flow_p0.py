...
# **********   Test Case  **************
def test_hosting_parmeterized_flow(hosting_plans, domain_action, payment_method, tlds, package_extras, term, before_test):
...
def pytest_generate_tests(metafunc):
    ...
    if "term" in metafunc.fixturenames:
        metafunc.parametrize("term", term_data)

# *************   All Test Data (static) below this point  ************

# All Hosting Type and Sub Type combos
shared_hosting_plans = [('shared', 'basic'), ('shared', 'plus'), ('shared', 'pro'), ('shared', 'choice_plus')]
#ecom_hosting_plans = [('ecom', 'starter'), ('ecom', 'plus'), ('ecom', 'pro')]
...
hosting_plans_data = [*shared_hosting_plans, *wppro_hosting_plans]
tlds_data = ['com']
payment_method_data = ['check']
domain_action_data = ['register', 'transfer', 'domainless']
#package_extras_info = [['codeguard_basic', 'SEO_tools', 'siteLock_security', 'domain_privacy_protection', 'microsoft_office_email']]
package_extras_info = [[]]
term_data = ['36']