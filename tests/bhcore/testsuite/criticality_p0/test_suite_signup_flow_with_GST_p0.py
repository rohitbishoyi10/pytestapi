...
# **********   Test Case  **************
def test_hosting_parmeterized_flow_with_GST(hosting_plans, domain_action, payment_method, tlds, gst_id, term, before_test):
...
hosting_plans_data = [*shared_hosting_plans]
tlds_data = ['com']
