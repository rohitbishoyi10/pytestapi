...
ProfessionalEmailSignup_locale_m = compose(pytest.mark.singaporeReady, pytest.mark.indiaReady)
...
@ProfessionalEmailSignup_locale_m
@pytest.mark.indiaReady
def test_professional_email_signupFlow(hosting_plans, domain_action, payment_method,term, tlds,before_test):
    ...
    Pro_Email_Signup_Flow_obj.term=term
...
def replica_professional_email_signupFlow(hosting_plans, domain_action, payment_method, term,tlds, before_test_child):
