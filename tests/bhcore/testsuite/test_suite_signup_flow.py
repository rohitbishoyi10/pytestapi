...
def test_hosting_parmeterized_flow(hosting_plans, domain_action, payment_method, tlds, term,package_extras, before_test):
...
wppro_hosting_plans = [('wppro', 'build'), ('wppro', 'grow'), ('wppro', 'scale')]
