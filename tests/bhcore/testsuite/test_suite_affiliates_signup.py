...
AffiliatesSignupFlow_locale_m = compose(pytest.mark.singaporeReady, pytest.mark.indiaReady)
...
@AffiliatesSignupFlow_locale_m
@pytest.mark.indiaReady
def test_hosting_parmeterized_flow(hosting_plans, domain_action, payment_method, tlds,term, before_test):
    ...
    Affiliates_Signup_flow.term = term
...
hosting_plans_data = [('shared', 'basic'), ('ecom', 'starter'), ('wppro', 'build')]
tlds_data = ['com']
